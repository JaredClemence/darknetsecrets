...
<div class="container">
    <div class="row">
        <div class="col">
            ...
            <h2>Privacy</h2>
            <p>This site collects and stores email addresses from persons interested in offered services. 
                Partner sites may collect other information from cookies stored in your 
                browser that this site does not control. Neither can this site access any of 
                that information that partner sites may have on you.
            <h2>Prizes and Contests</h2>
            <p>
                The site may offer items or services of value (collectively referred to as a "prize") to induce referrals.
                Unless otherwise specified, a person enters the contest by referring visitors 
                to the site who then register for future services (free or paid).
            </p>
            <p>
                The consideration in this arrangement shall not require the registrant to pay fees.
                The site understands that collecting money in exchange for entries constitutes a lottery, and 
                this site DOES NOT conduct lotteries.
            </p>
            <p>
                The site may run multiple contests simultaneously. The site runs varied contests 
                to test a variety of offers in pursuit of optimizing performance and increase 
                unique registrations. 
            </p>
            <p>
                Visitors may register for multiple contests with the same email address. The site 
                will not provide landing page links on request, visitors must find the contest 
                landing page via a paid advertisement or friend's referral.
            </p>
            <p>
                Visitors obtain entries to contests by registering valid email addresses. 
                Before the site provides an entry into a contest, the registered address 
                must be validated by the registrant. The site will send a unique url 
                to the provided email address that must be loaded in a browser to prove 
                that a person at the email address received the message. Before the site 
                provides a contest entry, the site visitor must satisfy the following requirements for 
                each contest registration:
            </p>
            <ul>
                ...
                <li>Performing any required action stated in the offer terms.</li>
            </ul>
            <p>
                A contest may allow a verified registrant to claim email addresses before 
            ...
            <ul>
                <li>An offer intended to increase referrals of verified registrants become 
                    binding upon the site's owner when the number of verified registrations exceeds 
                    10,000.</li>
            ...
            <p>
                A contest offer page may be disabled at any time. A contest will be 
            ...
            <p>
                By participating in a contest for a prize, the registered visitor agrees to 
            ...
            <p>
                A person who pays for services only becomes a paying customer when the 
            ...
            <p>
                The site will manage and maintain a list of purchases, purchase amount and 
                ...
                email address as a potential referral.
            </p>
            ...
            <p>
                This policy may be updated at any time. The updated policy becomes active 
                seven days after notice is transmitted to the registered visitors and takes 
                immediate effect for any new visitors.
            </p>
            <p>
                Offers that have not been accepted completely prior to the effective date 
                ...
                of the new offer under the new policy.
            </p>
